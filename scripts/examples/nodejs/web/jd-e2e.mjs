/**
 * 京东 Web 操控（本地 ada-client，四场景）
 * 运行：npm run test:jd-web
 * MCP：npm run test:jd-web:mcp（同四场景，全程 MCP）
 */
import { dir, open, browser, by, wait, exit, setKeepAlive } from "../../../lib/ada-client.mjs";
